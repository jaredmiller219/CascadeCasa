...
public class Bedroom1_Notepad : MonoBehaviour
{
    ...
    /// <summary>
    /// The reference to the gameobject with the Bedroom1_HorizontalScrollBar script attached to it
    /// </summary>
    [Tooltip("The reference to the gameobject with the Bedroom1_HorizontalScrollBar script attached to it")]
    [SerializeField]
    [Header("Notepad")]
    ...
    private void Start()
    {
        ...
        if (scrollBar == null) Debug.LogError("Bedroom1_HorizontalScrollBar not found in scene!");
    ...
    private string ScrollBarStrValToLower(Bedroom1_HorizontalScrollBar scrollBar, int index)
    {
