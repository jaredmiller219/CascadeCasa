...
public class PatioNotepad : MonoBehaviour
{
    /// <summary>
    ...
    private PatioChallengeImage selectedImage;
    ...
    private void LoadChallenge()
    {
        ...
        if (selectedImage != null)
        {
            ...
            currentChallengeIndex = selectedImage.GetComponent<PatioChallengeImage>()._buttonIndex;
