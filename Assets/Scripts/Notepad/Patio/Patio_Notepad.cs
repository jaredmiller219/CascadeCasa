...
public class Patio_Notepad : MonoBehaviour
{
    ...
    private void CheckCssInput()
    {
        ...
        if (inputField.GetComponent<TMP_InputField>().text != "" && canSubmit)
        {
            ...
            if (normalizedUserInput == normalizedCorrectCss)
            {
                ...
                var scrollBar = FindFirstObjectByType<Patio_HorizontalScrollBar>();
                if (scrollBar != null)
                {
    ...
    public void LoadChallenge()
    {
        ...
        {
            SetChallengeIndexFromButtonIndex(selectedImage.GetComponent<Patio_ChallengeImage>()._buttonIndex);
        }
