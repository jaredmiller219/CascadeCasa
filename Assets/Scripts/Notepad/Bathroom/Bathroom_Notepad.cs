...
public class Bathroom_Notepad : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (scrollBar == null) Debug.LogError("Bathroom_HorizontalScrollBar not found in scene!");
    ...
    private string ScrollBarStrValToLower(Bathroom_HorizontalScrollBar scrollBar, int index)
    {
